...
namespace ContactWeb.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public ContactsController(IStatesService statesService, IContactsService contactsService, IMemoryCache cache)
        {
            //_context = context;
        ...
        private async Task UpdateStateAndRestModelState(Contact contact)
        {
            ModelState.Clear();
        ...
        {
            await UpdateStateAndRestModelState(contact);
